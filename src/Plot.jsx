    ...
    return (
        <>
            ...
            <section className='hero'>
                <div
                    style={{
                        background: "rgba(0, 0, 0, 0.6) url('/images/plot.jpeg')", // Change to your image path
                ...
                >
                    ...
                    <Container className="py-5">
                        <h1 className="fw-bold display-5">
                            Find Your Ideal Plot,<br></br> Build Your Dream
                        </h1>
                        <p className="lead" style={{ maxWidth: "650px", margin: "0 auto" }}>
                            Find prime plots of land, ready for your vision, with easy access to amenities and diverse locations.
                        </p>
