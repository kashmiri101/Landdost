    ...
    return (
        <>
            ...
            <section className='hero'>
                <div
                    style={{
                        background: "rgba(0, 0, 0, 0.6) url('/images/apartment.webp')", // Change to your image path
                ...
                >
                    ...
                    <Container className="py-5">
                        <h1 className="fw-bold display-5">
                            Discover Your Ideal Apartment,<br></br> Where Comfort Meets Convenience
                        </h1>
                        <p className="lead" style={{ maxWidth: "650px", margin: "0 auto" }}>
                            Discover modern apartments for rent or sale, offering comfort, style, and prime locations with exceptional amenities.
                        </p>
