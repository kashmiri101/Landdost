    ...
    return (
        <>
            ...
            <section className='hero'>
                <div
                    style={{
                        background: "rgba(0, 0, 0, 0.6) url('/images/farmhouse.webp')", // Change to your image path
                ...
                >
                    ...
                    <Container className="py-5">
                        <h1 className="fw-bold display-5">
                            Find Your Dream Farmhouse,<br></br> Where Serenity Meets Comfort
                        </h1>
                        <p className="lead" style={{ maxWidth: "650px", margin: "0 auto" }}>
                            Explore spacious farmhouses that combine tranquility with modern living, offering the perfect countryside retreat.
                        </p>
